"""Run Optuna search for soft veto scaling under nonlinear rank."""
...
def run_optuna(config_path, params_path, reference_path, artifact_dir, optuna_config_path, perturb_runs, perturb_sigma, seed):
    ...
    study = optuna.create_study(
        ...
        storage=f"sqlite:///{root / 'optuna_veto_soft.db'}",
    ...
    def objective(trial):
        sv = trial.suggest_float("soft_veto_scale", 0.0, 0.95)
        metrics, _ = _eval({"soft_veto_scale": sv})
